/*
 * File: _coder_gravityVector_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL, "gravityVector",
 ...
 * Return Type  : void
 */
  void gravityVector_api(const mxArray *prhs[21], const mxArray *plhs[1])
{
  real_T (*gravity)[6];
  ...
  gravity = (real_T (*)[6])mxMalloc(sizeof(real_T [6]));
  ...
  gravityVector(*lengthVector, *massVector, g, *inertiaTensor_1,
                ...
                *angleVector, *angleVelocityVector, *angularAccelerationVector, *
                sinVector, *cosVector, *tiltVector, *gravity);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*gravity);
}
 ...
 * Return Type  : void
 */
void gravityVector_atexit(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void gravityVector_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void gravityVector_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_gravityVector_api.c
 *
 * [EOF]
 */
