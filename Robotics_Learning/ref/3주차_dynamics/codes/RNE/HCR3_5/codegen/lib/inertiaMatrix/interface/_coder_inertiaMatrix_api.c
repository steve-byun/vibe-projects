/*
 * File: _coder_inertiaMatrix_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL, "inertiaMatrix",
  NULL, false, { 2045744189U, 2170104910U, 2743257031U, 4284093946U }, NULL };

/* Function Declarations */
static real_T (*b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId))[6];
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *g, const
  char_T *identifier);
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *lengthVector, const char_T *identifier))[6];
  ...
  char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(g), &thisId);
  emlrtDestroyArray(&g);
  return y;
}
  ...
  *inertiaTensor_1, const char_T *identifier))[9]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = f_emlrt_marshallIn(sp, emlrtAlias(inertiaTensor_1), &thisId);
  ...
  *COMVector_1, const char_T *identifier))[3]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = h_emlrt_marshallIn(sp, emlrtAlias(COMVector_1), &thisId);
  ...
  *tiltVector, const char_T *identifier))[4]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = j_emlrt_marshallIn(sp, emlrtAlias(tiltVector), &thisId);
 ...
 * Return Type  : void
 */
  void inertiaMatrix_api(const mxArray *prhs[21], const mxArray *plhs[1])
{
  real_T (*inertia)[36];
  real_T (*lengthVector)[6];
  real_T (*massVector)[6];
  real_T g;
  ...
  inertia = (real_T (*)[36])mxMalloc(sizeof(real_T [36]));
  ...
  massVector = emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "massVector");
  g = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "g");
  inertiaTensor_1 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[3]),
    "inertiaTensor_1");
  inertiaTensor_2 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[4]),
    "inertiaTensor_2");
  inertiaTensor_3 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[5]),
    "inertiaTensor_3");
  inertiaTensor_4 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[6]),
    "inertiaTensor_4");
  inertiaTensor_5 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[7]),
    "inertiaTensor_5");
  inertiaTensor_6 = e_emlrt_marshallIn(&st, emlrtAlias(prhs[8]),
    "inertiaTensor_6");
  COMVector_1 = g_emlrt_marshallIn(&st, emlrtAlias(prhs[9]), "COMVector_1");
  COMVector_2 = g_emlrt_marshallIn(&st, emlrtAlias(prhs[10]), "COMVector_2");
  COMVector_3 = g_emlrt_marshallIn(&st, emlrtAlias(prhs[11]), "COMVector_3");
  COMVector_4 = g_emlrt_marshallIn(&st, emlrtAlias(prhs[12]), "COMVector_4");
  COMVector_5 = g_emlrt_marshallIn(&st, emlrtAlias(prhs[13]), "COMVector_5");
  COMVector_6 = g_emlrt_marshallIn(&st, emlrtAlias(prhs[14]), "COMVector_6");
  angleVector = emlrt_marshallIn(&st, emlrtAlias(prhs[15]), "angleVector");
  angleVelocityVector = emlrt_marshallIn(&st, emlrtAlias(prhs[16]),
    "angleVelocityVector");
  angularAccelerationVector = emlrt_marshallIn(&st, emlrtAlias(prhs[17]),
    "angularAccelerationVector");
  sinVector = emlrt_marshallIn(&st, emlrtAlias(prhs[18]), "sinVector");
  cosVector = emlrt_marshallIn(&st, emlrtAlias(prhs[19]), "cosVector");
  tiltVector = i_emlrt_marshallIn(&st, emlrtAlias(prhs[20]), "tiltVector");

  /* Invoke the target function */
  inertiaMatrix(*lengthVector, *massVector, g, *inertiaTensor_1,
                ...
                *angleVector, *angleVelocityVector, *angularAccelerationVector, *
                sinVector, *cosVector, *tiltVector, *inertia);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*inertia);
}
 ...
 * Return Type  : void
 */
void inertiaMatrix_atexit(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void inertiaMatrix_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void inertiaMatrix_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_inertiaMatrix_api.c
 *
 * [EOF]
 */
