...
function [Torque,torque_m,torque_c,torque_g,P,alpha,M,C,g] = Compute_Torque5_1gen(act_pos, act_vel, cmd_acc, Tilt, payLoadMass, payLoadCOM)
...
% mass
massVector(1) = 4.4018;
massVector(2) = 14.5906;
massVector(3) = 2.8375;
massVector(4) = 1.6783;
massVector(5) = 1.6783;
massVector(6) = 0.2936 + loadMass;
...
inertiaTensor_2(1) = 9.0693e-2;
inertiaTensor_2(2) = 2.0261e-5;
inertiaTensor_2(3) = 1.2567e-1;
inertiaTensor_2(4) = inertiaTensor_2(2);
inertiaTensor_2(5) = 7.4500e-1;
inertiaTensor_2(6) = -1.0807e-6;
inertiaTensor_2(7) = inertiaTensor_2(3);
inertiaTensor_2(8) = inertiaTensor_2(6);
inertiaTensor_2(9) = 6.7808e-1;
...
inertiaTensor_6(1) = 2.3369e-4;
inertiaTensor_6(2) = 1.4740e-6;
inertiaTensor_6(3) = -2.6120e-7;
inertiaTensor_6(4) = inertiaTensor_6(2);
inertiaTensor_6(5) = 2.3125e-4;
inertiaTensor_6(6) = -1.0978e-6;
inertiaTensor_6(7) = inertiaTensor_6(3);
inertiaTensor_6(8) = inertiaTensor_6(6);
inertiaTensor_6(9) = 3.7521e-4;
...
COMVector_2(1) = 3.0985e-1;
COMVector_2(2) = 1.9459e-6;
COMVector_2(3) = 9.1451e-2;
...
COMVector_6(1) = 3.1447e-5 + loadCOM(1);
COMVector_6(2) = -8.1082e-5 + loadCOM(2);
COMVector_6(3) = -2.1217e-2 - loadCOM(3);
