...
#include "main.h"
#include "gravityVector_terminate.h"
#include "gravityVector_initialize.h"
...
static void main_gravityVector();
...
static void main_gravityVector()
{
  ...
  // Initialize function 'gravityVector' input arguments.
  ...
  // Call the entry-point 'gravityVector'.
  ...
  gravityVector(lengthVector, massVector, g, inertiaTensor_1, inertiaTensor_2,
                inertiaTensor_3, inertiaTensor_4, inertiaTensor_5,
                inertiaTensor_6, COMVector_1, COMVector_2, dv0, dv1, dv2, dv3,
                dv4, dv5, dv6, dv7, dv8, dv9, gravity);
}
