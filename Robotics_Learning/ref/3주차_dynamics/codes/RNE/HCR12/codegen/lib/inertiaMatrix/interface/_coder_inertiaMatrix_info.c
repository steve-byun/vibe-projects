/*
 * File: _coder_inertiaMatrix_info.c
 *
...
/* Include Files */
#include "_coder_inertiaMatrix_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("inertiaMatrix"));
...
/*
 * File trailer for _coder_inertiaMatrix_info.c
 *
 * [EOF]
 */
