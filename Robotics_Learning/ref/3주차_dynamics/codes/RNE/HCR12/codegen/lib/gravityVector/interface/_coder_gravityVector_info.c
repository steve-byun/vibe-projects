/*
 * File: _coder_gravityVector_info.c
 *
...
/* Include Files */
#include "_coder_gravityVector_info.h"
...
mxArray *emlrtMexFcnProperties()
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("gravityVector"));
...
/*
 * File trailer for _coder_gravityVector_info.c
 *
 * [EOF]
 */
