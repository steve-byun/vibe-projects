...
#include "main.h"
#include "inertiaMatrix_terminate.h"
#include "inertiaMatrix_initialize.h"
...
static void main_inertiaMatrix();
...
static void main_inertiaMatrix()
{
  ...
  // Initialize function 'inertiaMatrix' input arguments.
  // Initialize function input argument 'lengthVector'.
  argInit_1x7_real_T(lengthVector);
  ...
  // Call the entry-point 'inertiaMatrix'.
  ...
  inertiaMatrix(lengthVector, massVector, g, inertiaTensor_1, inertiaTensor_2,
                inertiaTensor_3, inertiaTensor_4, inertiaTensor_5,
                inertiaTensor_6, COMVector_1, COMVector_2, dv0, dv1, dv2, dv3,
                dv4, dv5, dv6, dv7, dv8, dv9, inertia);
}
