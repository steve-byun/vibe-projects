/*
 * File: _coder_coriolisMatrix_mex.cpp
 *
...
static void coriolisMatrix_mexFunction(int32_T nlhs, mxArray *plhs[1], int32_T
  ...
  nrhs, const mxArray *prhs[21])
{
  ...
  /* Call the function. */
  coriolisMatrix_api(inputs, outputs);
...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs, const mxArray
                 *prhs[])
{
  mexAtExit(coriolisMatrix_atexit);
  ...
  coriolisMatrix_mexFunction(nlhs, plhs, nrhs, prhs);
}
...
/*
 * File trailer for _coder_coriolisMatrix_mex.cpp
 *
 * [EOF]
 */
