function [link_param, payload, fn, HCR5, grav, q0] = HCR_1gen_5_parameters(n_dof)

% HCR5 1st generation (units - [rad] , [m] , [kg], [kg.m^2] )
...
link_param{2}.m = 14.5906; link_param{2}.rc = [0.309850; 0.00000194590; 0.0914510]; 
link_param{2}.Ic = [
   0.090693000000000   0.000020261000000   0.125670000000000
   0.000020261000000   0.745000000000000  -0.000001080700000
   0.125670000000000  -0.000001080700000   0.678080000000000];
...
% link6
link_param{6}.a = 0; link_param{6}.alpha = 0; link_param{6}.d = 131.0*(1e-3); 
link_param{6}.m = 0.2936; link_param{6}.rc = [0.000031447000000  -0.000081082000000  -0.021217000000000];
link_param{6}.Ic = [
   0.233690000000000   0.001474000000000  -0.000261200000000
   0.001474000000000   0.231250000000000  -0.001097800000000
  -0.000261200000000  -0.001097800000000   0.375210000000000]*(1e-3);
