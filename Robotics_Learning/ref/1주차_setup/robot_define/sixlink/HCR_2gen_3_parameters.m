function [link_param, payload, fn, HCR3, grav, q0] = HCR_2gen_3_parameters(n_dof)

% HCR3 2nd generation (units - [rad] , [m] , [kg], [kg.m^2] )
...
% link4
link_param{4}.a = 0; link_param{4}.alpha = pi/2; link_param{4}.d = 148.6*(1e-3); 
...
% link5
link_param{5}.a = 0; link_param{5}.alpha = -pi/2; link_param{5}.d = 147.5*(1e-3); 
...
% link6
link_param{6}.a = 0; link_param{6}.alpha = 0; link_param{6}.d = 152*(1e-3); 
